<?php
/**
 * TechDivision_SystemConfigDiff_Block_Adminhtml_System_Config_Form_Field_Array_Abstract
 *
 * NOTICE OF LICENSE
 *
...
/**
 * Copy of core block for inheritance issues with Regexceptions and Form_Field.
 *
 * @category   TechDivision
 * @package    TechDivision_SystemConfigDiff
 * @subpackage Block
 ...
 * @author     Florian Sydekum <fs@techdivision.com>
 */
abstract class TechDivision_SystemConfigDiff_Block_Adminhtml_System_Config_Form_Field_Array_Abstract
    extends TechDivision_SystemConfigDiff_Block_Adminhtml_System_Config_Form_Field
{
    /**
     * Grid columns
     *
