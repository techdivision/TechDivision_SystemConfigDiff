<?php
/**
 * TechDivision_SystemConfigDiff_Block_Adminhtml_Overview_Tabs_Config
 *
 * NOTICE OF LICENSE
 *
...
/**
 * Config tab container implementation.
 *
 * @category   TechDivision
 * @package    TechDivision_SystemConfigDiff
 * @subpackage Block
 ...
 * @author     Florian Sydekum <fs@techdivision.com>
 */
class TechDivision_SystemConfigDiff_Block_Adminhtml_Overview_Tabs_Config extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    {
        $collection = Mage::getModel('techdivision_systemconfigdiff/config')->getCollection()->addFieldToFilter('systemXml', '0');
    ...
    public function getGridUrl()
    {
    	return $this->getData('grid_url')
            ...
            : $this->getUrl('*/*/configGrid', array('_current' => true));
    }
