<?php
/**
 * TechDivision_SystemConfigDiff_Block_Adminhtml_Overview_Tabs_Page
 *
 * NOTICE OF LICENSE
 *
...
/**
 * Page tab container implementation.
 *
 * @category   TechDivision
 * @package    TechDivision_SystemConfigDiff
 * @subpackage Block
 ...
 * @author     Florian Sydekum <fs@techdivision.com>
 */
class TechDivision_SystemConfigDiff_Block_Adminhtml_Overview_Tabs_Page extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    {
    	$collection = Mage::getModel('techdivision_systemconfigdiff/page')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'identifier',
            array(
                'header' => $this->defaultHelper()->__('Page identifier'),
                'align'  => 'right',
                'width'  => '130px',
                'index'  => 'identifier',
            )
    ...
    public function getGridUrl()
    {
    	return $this->getData('grid_url')
            ...
            : $this->getUrl('*/*/pageGrid', array('_current' => true));
    }
